...
* **Left diagonals**: The difference between the row and column numbers is the same for all squares on a diagonal going down towards the left. This difference can be used to number the diagonals.
...
Hang on! What about Part 2? I'll be solving the Queen problem using a *fourth* language&mdash;one that is different, more interesting and more fun than these three.

Can you guess which language that will be? Let me know in the comments!
